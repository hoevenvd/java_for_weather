...
<float> solarradiation: watts per sq meter
...
class Wunderground(HttpPublisher):
    ...
    def set( self, pressure='NA', dewpoint='NA', humidity='NA', tempf='NA',
            ...
            windgustdir='NA', windspeed='NA', winddir='NA', solarradiation='NA',
        ...
        #   soiltempf, soilmoisture, leafwetness, UV
