class CreateLastyearArchiveRecords < ActiveRecord::Migration
  def self.up
    create_table :lastyear_archive_records do |t|
    ...
    add_index "lastyear_archive_records", ["date", "location"], :name => "date_loc", :unique => true
    add_index "lastyear_archive_records", ["date"], :name => "dates"
    add_index "lastyear_archive_records", ["location"], :name => "locations"
  end

  def self.down
    drop_table :lastyear_archive_records
  end
end
