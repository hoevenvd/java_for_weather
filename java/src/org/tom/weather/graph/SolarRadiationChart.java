...
public class SolarRadiationChart extends BaseChart {
  ...
  public SolarRadiationChart(String location, DataSource source, String filename, Timestamp start, Timestamp end) {
  ...
  private XYDataset readData(String location, DataSource source, Timestamp start, Timestamp end) {
    ...
    try {
      ...
      String sql = "SELECT date - INTERVAL  " + Grapher.OFFSET / 1000 + " second , high_solar_radiation FROM archive_records"
