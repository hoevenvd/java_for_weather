...
public class RainRateChart extends BaseChart {

  private static final Logger LOGGER = Logger.getLogger(RainRateChart.class);
  
  public RainRateChart(String location, DataSource source, String filename, Timestamp start, Timestamp end) {
  ...
  private XYDataset readData(String location, DataSource source, Timestamp start, Timestamp end) {
    ...
    try {
      ...
      String sql = "SELECT date - INTERVAL  " + Grapher.OFFSET / 1000 + " second , high_rain_rate FROM archive_records"
